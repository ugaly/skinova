...
const styles = StyleSheet.create({
  ...
  heroSubtitle: { fontFamily: AppTypography.medium, fontSize: 13, color: '#5F7169', lineHeight: 19 },
  ...
  infoText: { marginTop: 8, fontFamily: AppTypography.medium, fontSize: 13, color: '#5F7169', lineHeight: 20 },
  supplierCard: {
    marginHorizontal: 20,
    marginBottom: 14,
    borderRadius: 16,
